...
subjectTest = read.table('~/data/UCIHAR/test/subject_test.txt',header=FALSE); #imports subject_test.txt
xTest       = read.table('~/data/UCIHAR/test/x_test.txt',header=FALSE); #imports x_test.txt
yTest       = read.table('~/data/UCIHAR/test/y_test.txt',header=FALSE); #imports y_test.txt
